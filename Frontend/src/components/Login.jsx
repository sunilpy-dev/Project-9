...
const Login = () => {
  ...
  const handleSubmission = async () => {
    let res = await fetch('https://snip-vault-backend.vercel.app/checkUser', { method: "POST", headers: { "content-type": "application/json" }, body: JSON.stringify({ ...loginForm }), credentials: "include" })
