...
const Login = () => {
  ...
  const handleSubmission = async () => {
    let res = await fetch('https://snip-vault-backend.onrender.com/checkUser', { method: "POST",credentials: "include", headers: { "content-type": "application/json" }, body: JSON.stringify({ ...loginForm }), credentials: "include" })
